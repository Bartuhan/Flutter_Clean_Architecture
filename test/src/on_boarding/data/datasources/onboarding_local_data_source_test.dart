...
class MockSharedPreferances extends Mock implements SharedPreferences {}
...
void main() {
  ...
  setUp(() {
    prefs = MockSharedPreferances();
    localDataSource = OnBoardingLocalDataSrcImpl(prefs);
  });

  group('cacheFirstTimer', () {
    test('should call [SharedPreferances] to cache the data', () async {
  ...
  group('checkIfUserFirstTimer', () {
    test(
      'should call [SharedPreferances] to check if user is first timer and '
    ...
    test(
      'should return true if there is no data storage ',
      () async {
