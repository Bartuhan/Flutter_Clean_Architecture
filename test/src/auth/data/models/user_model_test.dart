...
import 'package:education_app/src/auth/data/models/user_models.dart';
...
void main() {
  ...
  group('fromMap', () {
    test('should return a valid [LocalUser] from the map', () {
    ...
    test('should throw an [Error] when the the map is invalid', () {
